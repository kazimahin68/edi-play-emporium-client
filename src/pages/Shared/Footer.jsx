            ...
            <footer className="footer mb-5">
                <div className='footer md:w-4/5 mx-auto'>
                    <div className='content-center'>
                        <img className='w-24 rounded-full mb-5' src={logo} alt="" />
                        <p className='font-bold opacity-80'>EduPlay Emporium</p>
                    </div>
                    <div>
                        <span className="footer-title">Contact</span>
                        <a className="link link-hover font-semibold"><span className='font-bold opacity-80'>Phone: </span>+1-759-913-4297</a>
                        <a className="link link-hover font-semibold"><span className='font-bold opacity-80'>E-mail:</span> eduplay-emporium@hotmail.com</a>
                    </div>
                    <div>
