    ...
    return (
        <div className='bg-base-200 text-base-content mt-12 p-10'>
            <footer className="footer mb-5">
                <div className='footer md:w-4/5 mx-auto'>
                    <div>
                        ...
                        <p>EduPlay Emporium</p>
                    </div>
                    <div>
                        <span className="footer-title">Contact</span>
                        <a className="link link-hover">Phone: +1-759-913-4297</a>
                        <a className="link link-hover">E-mail: eduplay-emporium@hotmail.com</a>
                    </div>
                    <div>
                        <span className="footer-title">Address</span>
                        <a className="link link-hover">Street: 36641 Leta Heights</a>
                        <a className="link link-hover">City: Monahanmouth</a>
                        <a className="link link-hover">State: North Carolina</a>
                    </div>
                    <div>
            ...
            <div className='footer-center mt-5'>
                <p>Copyright © 2023 - All right reserved by EduPlay Emporium</p>
            </div>
        </div>
    );
};
